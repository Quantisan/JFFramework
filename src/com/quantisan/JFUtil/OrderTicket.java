...
public class OrderTicket {
	...
	private OrderTicket(Builder builder) {
		...
		amount = Rounder.lot(builder.amount);
		price = Rounder.pip(instrument, builder.price);
		slippage = builder.slippage;
		stopLossPrice = Rounder.pip(instrument, builder.stopLossPrice);
		takeProfitPrice = Rounder.pip(instrument, builder.takeProfitPrice);
